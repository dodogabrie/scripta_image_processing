...
from maglib.unimarc_import.mappings.manoscritto_musicale import anoscrittoMusicaleMapper
...
class BibAdder(UnimarcBibAdder):
    def _build_mapper(self):
        return anoscrittoMusicaleMapper (self._records_retriever, StubVirtualBidTester())
